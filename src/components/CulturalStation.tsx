...
export const CulturalStation: React.FC = () => {
  return (
    <section
      id="story"
      className="py-14 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 lg:px-8 bg-[#2A1B12] text-paper-ivory border-y border-brand-red/20 relative z-10"
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-brand-gold tracking-tight">
