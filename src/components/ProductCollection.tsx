...
const collectionItems: CraftItem[] = [
  ...
  },
  {
    ...
    price: 160000,
    materials: [
      "Bột tò he 7 màu cao cấp không dính tay",
      "Que tre nặn truyền thống",
      "Bộ dụng cụ tạo hình tò he",
      "Giấy hướng dẫn sử dụng (HDSD)",
    ],
    secretItem: "",
  ...
  },
  {
    ...
    price: 160000,
    materials: [
      "2 Chuồn chuồn tre mộc chưa sơn",
      "Chân đế",
      "Khay pha màu",
      "Bộ vỉ màu Acrylic kèm 2 cọ vẽ",
      "Giấy hướng dẫn sử dụng (HDSD)",
    ],
    secretItem: "",
