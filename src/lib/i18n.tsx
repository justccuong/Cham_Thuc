...
export const translations: Record<Language, Translations> = {
  vi: {
    ...
    modal: {
      ...
      giftHeader: "ẢNH SẢN PHẨM & TRẢI NGHIỆM:",
      giftNoteTitle: "Lưu ý thành phần ngẫu nhiên",
      giftNoteDesc:
        "Mỗi hộp chắc chắn gồm bộ dụng cụ làm thủ công đầy đủ, đi kèm 1 chiếc nón lụa mini màu ngẫu nhiên.",
    ...
    b2b: {
      badge: "DOANH NGHIỆP",
      title: "Giải pháp quà tặng văn hóa B2B",
      subtitle: "Mang trải nghiệm văn hóa Việt vào quà tặng doanh nghiệp",
      pillar1Title: "Lan tỏa văn hóa Việt",
      pillar1Desc: "Mỗi hộp quà gắn với một làng nghề truyền thống, giúp doanh nghiệp trao tặng không chỉ một món quà mà còn một câu chuyện văn hóa Việt Nam.",
      pillar2Title: "Kết nối nghệ nhân và làng nghề",
      pillar2Desc: "Góp phần đưa sản phẩm và giá trị của làng nghề đến gần hơn với khách hàng, đối tác và cộng đồng thông qua một hình thức trải nghiệm hiện đại.",
      pillar3Title: "Đồng hành cùng ESG",
      pillar3Desc: "Kết hợp giá trị văn hóa, cộng đồng và tiêu dùng có trách nhiệm trong các chương trình quà tặng doanh nghiệp, góp phần tạo thêm giá trị xã hội từ mỗi sản phẩm.",
  ...
  en: {
    ...
    b2b: {
      badge: "CORPORATE",
      title: "B2B Cultural Gifting Solutions",
      subtitle: "Bringing Vietnamese cultural experiences into corporate gifting",
      pillar1Title: "Spreading Vietnamese Culture",
      pillar1Desc: "Each gift box connects with a traditional craft village, helping enterprises deliver not just a gift, but an authentic Vietnamese cultural story.",
      pillar2Title: "Connecting Artisans & Craft Villages",
      pillar2Desc: "Bringing craft village products and cultural values closer to customers, partners, and communities through modern experiential formats.",
      pillar3Title: "Partnering with ESG",
      pillar3Desc: "Combining cultural values, community engagement, and responsible consumption in corporate gifting programs, adding social value to every product.",
